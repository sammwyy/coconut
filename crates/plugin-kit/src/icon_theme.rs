//! Relocated from `apps/shell/src/icon_theme.rs` (Phase 3 of the plugin-kit
//! refactor): plugin crates need freedesktop icon-theme resolution too
//! (app icons, window icons), and can't depend on the `apps/shell` binary
//! crate.
