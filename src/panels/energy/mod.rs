...
use crate::integrations::power_profile::{PowerProfile, PowerProfileIntegration};
...
fn profile_row(profile: &PowerProfile, power_profile: Rc<dyn PowerProfileIntegration>) -> BoxedWidget {
